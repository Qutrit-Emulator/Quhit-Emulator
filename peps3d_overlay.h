...
/* Derived powers of χ — for basis encoding only, NOT RAM allocation */
#define TNS3D_CHI2  (TNS3D_CHI * TNS3D_CHI)
#define TNS3D_CHI3  (TNS3D_CHI * TNS3D_CHI * TNS3D_CHI)
#define TNS3D_CHI4  (TNS3D_CHI2 * TNS3D_CHI2)
#define TNS3D_CHI5  (TNS3D_CHI2 * TNS3D_CHI3)
#define TNS3D_CHI6  (TNS3D_CHI3 * TNS3D_CHI3)
#define TNS3D_TSIZ  (TNS3D_D * TNS3D_CHI6)
#define TNS3D_SVDDIM (TNS3D_D * TNS3D_CHI5)
